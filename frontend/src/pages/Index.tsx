...
const FILE_TYPE_HINTS = [
  { label: "PDF",  color: "bg-blue-100 text-blue-700" },
  { label: "DOCX", color: "bg-green-100 text-green-700" },
  { label: "TXT",  color: "bg-gray-100 text-gray-600" },
];
          ...
          <div className="rounded-2xl border border-border bg-card p-8 space-y-6 min-h-[480px] flex flex-col justify-center">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-2 mt-4">
                {FILE_TYPE_HINTS.map(({ label, color }) => (
            ...
            <Input
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" && file && title.trim() && !mutation.isPending) {
                  mutation.mutate();
                }
              }}
            />
